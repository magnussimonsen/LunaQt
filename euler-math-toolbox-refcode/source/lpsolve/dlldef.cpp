...
EXPORT int DllEntryPoint (HINSTANCE hInstance,
...
header *make_header (int type, size_t size)
{	
...
{	
	int size=(int)sizeof(header)+((int)strlen(s)/2+1)*2;
